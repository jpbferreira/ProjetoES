...
<body>
	...
	<nav aria-label="breadcrumb">
		...
		<ol class="breadcrumb" id="item-breadcrumb">
			...
			<li class="breadcrumb-item active" aria-current="page">Cadastro de Médico</li>
		</ol>
	</nav>

			

	<form id="form_funcionario" method="post" action="../../Controller/Medico/incluir_medico.php">
	<?php
		$vetor['nome'] = '';
        $vetor['cpf'] = '';
        $vetor['crm'] = '';
	...
	<div class="panel panel-default panel-table center-block">
		<h2 class="text-center">Cadastro de novo Médico</h2>
		<table class="table table-hover">
            ...
            <tr><td class="celula">CRM:</td>
				<td>
					<input type="text" name="crm" class="form-control" value="<?php echo $vetor['crm']; ?>" maxlength="5" size="12" />
				</td>
			</tr>
