...
<body>
	...
	<nav aria-label="breadcrumb">
		...
		<ol class="breadcrumb" id="item-breadcrumb">
			...
			<li class="breadcrumb-item"><a href="index_secretaria.php">Gerenciamento de Funcionário</a></li>
			<li class="breadcrumb-item active" aria-current="page">Cadastro de Secretária</li>
		</ol>
	</nav>

	<form id="form_funcionario" method="post" action="../../Controller/Secretaria/update_secretaria.php">
	<?php
	if(isset($_GET["codigo"])){
        include("../../conf/config.php");
  		$con = mysqli_connect($host, $login, $senha, $bd);
		
  		$sql = "select nome, cpf, data_nascimento, salario, sexo, setor_responsavel from Funcionario, Secretaria where Funcionario.cod_Func = ".$_GET['codigo']." and Secretaria.cod_Func = ".$_GET['codigo'];
	...
	<div class="panel panel-default panel-table center-block">
		...
		<h2 class="text-center">Cadastro de Secretária</h2>
		<table class="table table-hover">
            ...
            <tr><td class="celula">Setor Responsável</td>
				<td>
					<select class="form-control" id="sel1" name="setor">
						<option><?php echo $vetor['setor_responsavel']; ?></option>
		...
		<input type="button" class="btn btn-danger pull-right" value="Cancelar" onclick="location.href='index_secretaria.php'" />
		</div>
	</div>
    <?php } ?>
	</form>
